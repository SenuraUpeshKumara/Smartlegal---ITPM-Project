...
const ViewCaseDetails = () => {
  ...
  return (
    <Container maxWidth="lg" sx={{ mt: 5, position: "relative" }}>
      {/* View All Legal Cases Button (Right Side) */}
      {/* View All Legal Cases Button (Right Side) */}
      <Box
        sx={{
          position: "absolute",
      ...
      {/* Print Document Button (Left Side) */}
      <Box
        sx={{
          position: "absolute",
          top: 0,
      ...
      >
        <Button
          variant="contained"
          color="secondary"
          onClick={() => navigate(`/print-case/${caseDetails._id}`)} // Navigate to print route
        >
          Print Document
        </Button>
      </Box>
        ...
        <Box display="flex" justifyContent="center">
          {caseDetails.caseStatus !== "resolved" && (
            <Button
              variant="contained"
              sx={{
                backgroundColor: "#FFD700", // Standard gold/yellow
                color: "black",
                "&:hover": {
                  backgroundColor: "#CCAA00", // Darker yellow on hover
                },
                m: 1,
              }}
