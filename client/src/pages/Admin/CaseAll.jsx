...
const AllLegalCases = () => {
  ...
  const filteredCases = legalCases.filter((legalCase) =>
    legalCase.caseType.toLowerCase().includes(searchTerm.toLowerCase())
  );
  ...
  if (filteredCases.length === 0) {
    const message = searchTerm
      ? `No legal cases match the search criteria: "${searchTerm}".`
                ...
                >
                  ...
                  <Box
                    ...
                    sx={{
                      ...
                      fontSize: "0.875rem",
                      fontWeight: "bold",
                      ...(legalCase.caseStatus === "pending" && {
                        bgcolor: "warning.light",
                        color: "warning.dark",
                      }),
                      ...(legalCase.caseStatus === "approved" && {
                        bgcolor: "success.light",
                        color: "success.dark",
                      }),
                      ...(legalCase.caseStatus === "rejected" && {
                        bgcolor: "error.light",
                        color: "error.dark",
                      }),
                  ...
                  >
                    {legalCase.caseStatus
                      ? legalCase.caseStatus.charAt(0).toUpperCase() +
                        legalCase.caseStatus.slice(1)
                      : "Unknown"}
                  </Box>
                </Typography>
              </CardContent>
